						 ...
						 <tr>
							...
							<td class="text-right1">
								<div class="btn-group btn-group-xs ">
									...
									<?php echo $this->Html->link("<i class='fa fa-check'></i>",array('controller'=>'colleges','action'=>'certificatedeploy',$certificate['id']),array('class'=>'btn btn-inverse','escape'=>false,'title'=>'Deploye certificate')) ; ?>
									 <?php } ?>
								</div>
							</td>
						</tr>
