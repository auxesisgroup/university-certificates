							...
							<td class="text-right1">
								<div class="btn-group btn-group-xs ">
								    <?php echo $this->Html->link("<i class='fa fa-eye'></i>",array('controller'=>'certificates','action'=>'detail',$certificate['id']),array('class'=>'btn btn-inverse','escape'=>false,'title'=>'View Certificate')) ; ?>
									 <?php  if(($statusid==3)&&($roleId=='1')) {  ?>
										   <?php echo $this->Html->link("<i class='fa fa-eye'></i>",array('controller'=>'universities','action'=>'approve',$certificate['id']),array('class'=>'btn btn-inverse','escape'=>false,'title'=>'Approve certificate')) ; ?>
									 <?php } ?>
								</div>
							</td>
						</tr>
