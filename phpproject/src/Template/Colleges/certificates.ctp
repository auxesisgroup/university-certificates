						 ...
						 <tr>
							...
							<td class="text-right1">
								<div class="btn-group btn-group-xs ">
								    <?php echo $this->Html->link("<i class='fa fa-eye'></i>",array('controller'=>'colleges','action'=>'viewcollege',$certificate['id']),array('class'=>'btn btn-inverse','escape'=>false,'title'=>'View Certificate')) ; ?>
									<?php if($statusid==1) { ?>
									<?php echo $this->Html->link("<i class='fa fa-eye'></i>",array('controller'=>'colleges','action'=>'certificatedeploy',$certificate['id']),array('class'=>'btn btn-inverse','escape'=>false,'title'=>'Deploye')) ; ?>
									 <?php } ?>
								</div>
							</td>
						</tr>
