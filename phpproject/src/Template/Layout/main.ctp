...
<body>
    <div class="navbar navbar-fixed-top navbar-primaryu main" role="navigation">
			...
			<div class="navbar-header pull-left">
				<div class="navbar-brand">
					<div class="pull-left">
					 ...
					 <a href='javascript:void(0)' class='appbrand innerL' style="color:#fff">University Portal</a>
				</div>
			</div>
			<ul class="nav navbar-nav navbar-right hidden-xs">
					<li><?php echo $this->Html->link("<i class='fa fa-sign-out' style='color:#fff'></i>",array('controller'=>'universities','action'=>'logout'),array('class'=>'menu-icon','escape'=>false,'title'=>'Logout')) ;?></li>
			</ul>
		</div>
