...
<head>
    ...
    <?php echo $this->Html->script(array('admin/library/jquery/jquery.min','admin/plugins/less-js/less.min','admin/plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min')) ; ?>
